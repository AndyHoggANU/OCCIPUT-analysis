...
The observed EKE anomaly \citep[calculated using data from ][ and filtered using the same methods as model output]{Martinez-Moreno2022} indicates that observations are indistinguishable from the individual ensemble members (with the exception of a short period of anomalously low EKE in the early part of the satellite record).
...
Averaged over this broad region the fraction, $R_i$, of intrinsic variance is 0.82, confirming the visual impression that intrinsic processes dominate the variability in the eddy field averaged over the basin.
